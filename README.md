...
- **"Build my sales document."** Four questions, then the script, the client page rendered from
  it, and a stop for your yes on the price line and the plan. Once.
- **"Prep me for [name]."** The morning of the call. It reads what you already know about them
  and their booking answers, writes the one question that proves you looked, and prints one
  screen. Nothing to approve.
- **"I just got off a call with [name]."** Paste the transcript, or your notes, or nothing. It
  grades the hour against five gates, names the one thing to fix, drafts the follow-up you send
  inside the hour, and updates your script with what the call taught.

Two more, any time: **"Sort my replies"** with the batch pasted, and every reply lands in one of
five buckets with a draft under it. **"Update the script with this: ..."** and the line changes,
with your yes when it is one you say out loud.

Stopped halfway, or closed the laptop? Say **"continue the Close"** in a new window. It reads
