...
| Question | "how much", "do you do X", "how long" | Answer from the offer document, ask one back. A priced question whose scope fits one sentence is interested instead, and gets the way to pay | Day 4, one bump, then the not-now shelf | `TALKING` |
